    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_year', models.ForeignKey(default='2025', help_text='The event year this submission period is for', on_delete=django.db.models.deletion.CASCADE, related_name='submission_periods', to='home.eventyear')),
            ],
        ),
        migrations.CreateModel(
            name='Proposal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Speak at PyCon Uganda', max_length=250)),
                ('content', markdownx.models.MarkdownxField(default='', help_text='[Supports Markdown] - Content.')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('event_year', models.ForeignKey(default='2025', on_delete=django.db.models.deletion.CASCADE, related_name='proposing_talks', to='home.eventyear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Recording GL at PyCon Uganda', max_length=250)),
                ('content', markdownx.models.MarkdownxField(default='', help_text='[Supports Markdown] - Content.')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('event_year', models.ForeignKey(default='2025', on_delete=django.db.models.deletion.CASCADE, related_name='recordings', to='home.eventyear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Speak at PyCon Uganda', max_length=250)),
                ('content', markdownx.models.MarkdownxField(default='', help_text='[Supports Markdown] - Content for speaking at PyCon Uganda.')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('event_year', models.ForeignKey(default='2025', on_delete=django.db.models.deletion.CASCADE, related_name='speaks', to='home.eventyear')),
